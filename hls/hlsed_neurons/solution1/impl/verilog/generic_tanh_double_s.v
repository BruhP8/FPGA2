...
wire   [63:0] p_Result_8_fu_175_p3;
reg   [63:0] p_Result_8_reg_334;
...
wire   [51:0] tmp_V_1_fu_166_p1;
wire   [10:0] tmp_V_2_fu_254_p4;
wire   [63:0] p_Val2_s_fu_144_p1;
wire   [62:0] trunc_ln368_fu_171_p1;
wire   [0:0] icmp_ln833_1_fu_201_p2;
wire   [0:0] grp_fu_121_p2;
wire   [63:0] p_Val2_1_fu_242_p1;
...
nerons_dadddsub_64ns_64ns_64_5_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
nerons_dadddsub_64ns_64ns_64_5_full_dsp_1_U15(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_98_p0),
    .din1(grp_fu_98_p1),
...
nerons_dmul_64ns_64ns_64_6_max_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
nerons_dmul_64ns_64ns_64_6_max_dsp_1_U16(
    .clk(ap_clk),
    .reset(ap_rst),
...
nerons_ddiv_64ns_64ns_64_31_1 #(
    .ID( 1 ),
    .NUM_STAGE( 31 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
nerons_ddiv_64ns_64ns_64_31_1_U17(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_111_p0),
    .din1(reg_131),
...
nerons_dcmp_64ns_64ns_1_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 1 ))
nerons_dcmp_64ns_64ns_1_2_1_U18(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_116_p0),
...
always @ (posedge ap_clk) begin
    if ((((1'b1 == ap_CS_fsm_state8) & (or_ln10_fu_271_p2 == 1'd0) & (p_Result_7_fu_246_p3 == 1'd0)) | ((1'b1 == ap_CS_fsm_state8) & (or_ln9_fu_283_p2 == 1'd0) & (p_Result_7_fu_246_p3 == 1'd1)))) begin
        expx_reg_58 <= x_2_fu_235_p3;
    end else if ((1'b1 == ap_CS_fsm_state34)) begin
        expx_reg_58 <= tmp_i_30_reg_404;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        p_Result_8_reg_334[62 : 0] <= p_Result_8_fu_175_p3[62 : 0];
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (((or_ln10_fu_271_p2 == 1'd0) & (p_Result_7_fu_246_p3 == 1'd0)) | ((or_ln9_fu_283_p2 == 1'd0) & (p_Result_7_fu_246_p3 == 1'd1))))) begin
...
assign abst_in_fu_183_p1 = p_Result_8_fu_175_p3;

assign and_ln75_fu_207_p2 = (icmp_ln833_1_fu_201_p2 & grp_fu_121_p2);
...
assign grp_fu_116_p0 = p_Result_8_fu_175_p3;

assign grp_fu_121_p2 = ((tmp_V_1_fu_166_p1 == 52'd0) ? 1'b1 : 1'b0);

assign grp_fu_126_p2 = ((tmp_V_2_fu_254_p4 == 11'd0) ? 1'b1 : 1'b0);

assign icmp_ln10_fu_265_p2 = ((tmp_V_2_fu_254_p4 > 11'd996) ? 1'b1 : 1'b0);

assign icmp_ln833_1_fu_201_p2 = ((tmp_V_fu_156_p4 == 11'd968) ? 1'b1 : 1'b0);
...
assign icmp_ln9_fu_277_p2 = ((tmp_V_2_fu_254_p4 > 11'd995) ? 1'b1 : 1'b0);

assign or_ln10_fu_271_p2 = (icmp_ln10_fu_265_p2 | grp_fu_126_p2);

assign or_ln9_fu_283_p2 = (icmp_ln9_fu_277_p2 | grp_fu_126_p2);

assign p_Result_7_fu_246_p3 = p_Val2_1_fu_242_p1[32'd63];

assign p_Result_8_fu_175_p3 = {{1'd0}, {trunc_ln368_fu_171_p1}};

assign p_Val2_1_fu_242_p1 = x_2_fu_235_p3;
...
assign tmp_V_1_fu_166_p1 = p_Val2_s_fu_144_p1[51:0];

assign tmp_V_2_fu_254_p4 = {{p_Val2_1_fu_242_p1[62:52]}};
...
assign xor_ln84_fu_226_p2 = (p_Result_8_reg_334 ^ 64'd9223372036854775808);

assign xor_ln95_fu_314_p2 = (bitcast_ln95_fu_310_p1 ^ 64'd9223372036854775808);

always @ (posedge ap_clk) begin
    p_Result_8_reg_334[63] <= 1'b0;
