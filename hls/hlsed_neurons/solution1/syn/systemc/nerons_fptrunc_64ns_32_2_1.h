...
// ==============================================================
#ifndef __nerons_fptrunc_64ns_32_2_1__HH__
#define __nerons_fptrunc_64ns_32_2_1__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(nerons_fptrunc_64ns_32_2_1) {
    ...
    SC_CTOR(nerons_fptrunc_64ns_32_2_1):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
