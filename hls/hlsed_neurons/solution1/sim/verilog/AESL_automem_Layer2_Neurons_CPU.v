...
module AESL_automem_Layer2_Neurons_CPU (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.nerons.autotvin_Layer2_Neurons_CPU.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.nerons.autotvout_Layer2_Neurons_CPU.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 16;
parameter ADDR_WIDTH = 32'd 10;
parameter DEPTH = 32'd 1014;
parameter DLY = 0.1;
