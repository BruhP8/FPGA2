...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.nerons.autotvin_Layer2_Neurons_CPU.dat"
         "c.nerons.autotvin_Layer5_Neurons_CPU.dat"
         "c.nerons.autotvout_Layer5_Neurons_CPU.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.nerons.autotvout_Layer5_Neurons_CPU.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
