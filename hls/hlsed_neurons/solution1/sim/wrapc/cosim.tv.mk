...
IFLAG += -D__SIM_DDS__
IFLAG += -D__DSP48E1__
IFLAG += -B/usr/lib/x86_64-linux-gnu -Wno-unknown-pragmas
...
$(ObjDir)/345.cpp_pre.cpp.tb.o : 345.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling 345.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
