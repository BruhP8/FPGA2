...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "nerons.autotvin.dat"
	set constFileTvOut       "nerons.autotvout.dat"
	set constFileHdlTvIn     "nerons.autohdltvin.dat"
	set constFileHdlTvOut    "nerons.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
